...
public class SaleService {
    ...
    public SaleResponse deleteByIdSale(String skucode) throws IdNotFoundException {
        Optional<SaleEntity> sale= this.saleRepository.findSaleEntitiesBySaleCode(skucode);
        if (!sale.isPresent()){
            throw new  IdNotFoundException("the id was not found");
        }
        else{
